...
public class numberToWords {
    ...
    public static void numberToWord(int number) {
        ...
        int countZeroes = getDigitCount(number) - getDigitCount(reverse(number));
        int printNumber;
    ...
    public static int reverse(int number) {
        ...
        while(number != 0) {
            reverseNum *= 10;            //add new place value
            reverseNum += number % 10;   //get last digit and save to reverseNum
